...
/**
 * Vigenere Decode operation
 */
class VigenereDecode extends Operation {

    /**
     * VigenereDecode constructor
     */
    constructor() {
        super();

        this.name = "Vigenere Decode";
        this.module = "Ciphers";
    ...
    /**
     * Highlight Vigenere Decode in reverse
     *
     * @param {Object[]} pos
     * @param {number} pos[].start
     * @param {number} pos[].end
