...
/**
 * Vigenere Encode operation
 */
class VigenereEncode extends Operation {

    /**
     * VigenereEncode constructor
     */
    constructor() {
        super();

        this.name = "Vigenere Encode";
        this.module = "Ciphers";
        ...
        this.infoURL = "https://wikipedia.org/wiki/Vigenere_cipher";
    ...
    /**
     * Highlight Vigenere Encode in reverse
     *
     * @param {Object[]} pos
     * @param {number} pos[].start
     * @param {number} pos[].end
