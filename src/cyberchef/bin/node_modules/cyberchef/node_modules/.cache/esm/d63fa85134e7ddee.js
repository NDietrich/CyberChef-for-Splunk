...
class Recipe  {
    ...
    async _hydrateOpList() {
        if (!modules) {
            ...
            modules = await _34e‍.i(/* webpackMode: "eager" */ "./config/modules/OpModules.mjs");
