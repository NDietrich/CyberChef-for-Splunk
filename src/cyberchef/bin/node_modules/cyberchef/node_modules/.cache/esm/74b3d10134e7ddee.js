let NodeDish,NodeRecipe,OperationConfig,sanitise,removeSubheadingsFromArray,sentenceToCamelCase,ExcludedOperationError;_34e‍.x([["_wrap",()=>_wrap],["help",()=>help],["bake",()=>bake],["_explainExcludedFunction",()=>_explainExcludedFunction]]);_34e‍.w("./NodeDish.mjs",[["default",["NodeDish"],function(v){NodeDish=v}]]);_34e‍.w("./NodeRecipe.mjs",[["default",["NodeRecipe"],function(v){NodeRecipe=v}]]);_34e‍.w("../core/config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_34e‍.w("./apiUtils.mjs",[["sanitise",["sanitise"],function(v){sanitise=v}],["removeSubheadingsFromArray",["removeSubheadingsFromArray"],function(v){removeSubheadingsFromArray=v}],["sentenceToCamelCase",["sentenceToCamelCase"],function(v){sentenceToCamelCase=v}]]);_34e‍.w("../core/errors/ExcludedOperationError.mjs",[["default",["ExcludedOperationError"],function(v){ExcludedOperationError=v}]]);/**
...
function transformArgs(opArgsList, newArgs) {
    ...
    const opArgs = Object.assign([], opArgsList).map((a) => {
        if (Array.isArray(a.value)) {
            a.value = _34e‍.a("removeSubheadingsFromArray",removeSubheadingsFromArray)(a.value);
        }
        return a;
    });
...
function ensureIsDish(input) {
    if (!input) {
        return new (_34e‍.a("NodeDish",NodeDish))();
    }

    if (input instanceof _34e‍.a("NodeDish",NodeDish)) {
        return input;
    } else {
        return new (_34e‍.a("NodeDish",NodeDish))(input);
    }
}
    ...
    op.args.forEach((a) => {
        if (a.type === "option" || a.type === "editableOption") {
            result[sentenceToCamelCase(a.name)] = {
                type: a.type,
                options: _34e‍.a("removeSubheadingsFromArray",removeSubheadingsFromArray)(a.value)
            };
        } else if (a.type === "toggleString") {
            result[sentenceToCamelCase(a.name)] = {
                type: a.type,
                value: a.value,
                toggleValues: _34e‍.a("removeSubheadingsFromArray",removeSubheadingsFromArray)(a.toggleValues),
            };
        } else {
            result[sentenceToCamelCase(a.name)] = {
                type: a.type,
 ...
 */
    ...
    // matches first.
    const matches = Object.keys(_34e‍.a("OperationConfig",OperationConfig))
        // hydrate operation: swap op name for op config object (with name)
        .map((m) => {
            const hydrated = _34e‍.a("OperationConfig",OperationConfig)[m];
            hydrated.name = m;

            // flag up an exact name match. Only first exact match counts.
            if (!exactMatchExists) {
                exactMatchExists = _34e‍.a("sanitise",sanitise)(hydrated.name) === _34e‍.a("sanitise",sanitise)(searchTerm);
            }
            // Return hydrated along with what type of match it was
            return {
                hydrated,
                nameExactMatch: _34e‍.a("sanitise",sanitise)(hydrated.name) === _34e‍.a("sanitise",sanitise)(searchTerm),
                nameMatch: _34e‍.a("sanitise",sanitise)(hydrated.name).includes(_34e‍.a("sanitise",sanitise)(searchTerm)),
                descMatch: _34e‍.a("sanitise",sanitise)(hydrated.description).includes(_34e‍.a("sanitise",sanitise)(searchTerm))
            };
        })
 ...
 */
    ...
    const recipe =  new (_34e‍.a("NodeRecipe",NodeRecipe))(recipeConfig);
    const dish = ensureIsDish(input);
 ...
 */
    ...
    */
    const func = () => {
        throw new (_34e‍.a("ExcludedOperationError",ExcludedOperationError))(`Sorry, the ${name} operation is not available in the Node.js version of CyberChef.`);
    };
