let Utils,OperationError;_34e‍.x([["toBase64",()=>toBase64],["fromBase64",()=>fromBase64],["ALPHABET_OPTIONS",()=>ALPHABET_OPTIONS]]);_34e‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);_34e‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);/**
 * Base64 functions.
 *
 ...
 */
    ...
    if (typeof data == "string") {
        data = _34e‍.a("Utils",Utils).strToByteArray(data);
    }

    alphabet = _34e‍.a("Utils",Utils).expandAlphRange(alphabet).join("");
    if (alphabet.length !== 64 && alphabet.length !== 65) { // Allow for padding
        throw new (_34e‍.a("OperationError",OperationError))(`Invalid Base64 alphabet length (${alphabet.length}): ${alphabet}`);
    }
 ...
 */
       function fromBase64(data, alphabet="A-Za-z0-9+/=", returnType="string", removeNonAlphChars=true) {
    if (!data) {
    ...
    return returnType === "string" ? _34e‍.a("Utils",Utils).byteArrayToUtf8(output) : output;
}
