let Utils;_34e‍.x([["toHex",()=>toHex],["toHexFast",()=>toHexFast],["fromHex",()=>fromHex],["TO_HEX_DELIM_OPTIONS",()=>TO_HEX_DELIM_OPTIONS],["FROM_HEX_DELIM_OPTIONS",()=>FROM_HEX_DELIM_OPTIONS]]);_34e‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);/**
 ...
 */
    ...
    if (delim !== "None") {
        const delimRegex = delim === "Auto" ? /[^a-f\d]|(0x)/gi : _34e‍.a("Utils",Utils).regexRep(delim);
 ...
 */
       const TO_HEX_DELIM_OPTIONS = ["Space", "Percent", "Comma", "Semi-colon", "Colon", "Line feed", "CRLF", "0x", "0x with comma", "\\x", "None"];;_34e‍.j(["TO_HEX_DELIM_OPTIONS"]);


/**
 * From Hexadecimal delimiters.
 */
       const FROM_HEX_DELIM_OPTIONS = ["Auto"].concat(TO_HEX_DELIM_OPTIONS);;_34e‍.j(["FROM_HEX_DELIM_OPTIONS"]);
