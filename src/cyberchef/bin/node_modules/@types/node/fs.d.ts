...
declare module 'fs' {
     ...
     *
     * To get a behavior similar to the `remove dir` Unix command, use {@link rm} with options `{ recursive: true, force: true }`.
     * @since v0.0.2
     */
     ...
     *
     * To get a behavior similar to the `remove dir` Unix command, use {@link rmSync} with options `{ recursive: true, force: true }`.
     * @since v0.1.21
     */
