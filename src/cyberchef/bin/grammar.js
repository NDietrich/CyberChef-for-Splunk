...
var grammar = {
    ...
    {"name": "INOPTION", "symbols": ["INOPTION$subexpression$1", "_", {"literal":"=","pos":137}, "_", "FIELDNAME"], "postprocess": function(d) {return {infield:d[4]}}},
    {"name": "INOPTION$subexpression$2", "symbols": [/[iI]/, /[nN]/, /[fF]/, /[iI]/, /[eE]/, /[lL]/, /[dD]/], "postprocess": function(e){return e.join("")}},
    {"name": "INOPTION", "symbols": ["INOPTION$subexpression$2", "_", {"literal":"=","pos":152}, "_", {"literal":"'","pos":156}, "QUOTEDFIELDNAME", {"literal":"'","pos":160}], "postprocess": function(d) {return {infield:d[5]}}},
    {"name": "INOPTION$subexpression$3", "symbols": [/[iI]/, /[nN]/, /[fF]/, /[iI]/, /[eE]/, /[lL]/, /[dD]/], "postprocess": function(e){return e.join("")}},
    {"name": "INOPTION", "symbols": ["INOPTION$subexpression$3", "_", {"literal":"=","pos":171}, "_", {"literal":"\"","pos":175}, "QUOTEDFIELDNAME", {"literal":"\"","pos":179}], "postprocess": function(d) {return {infield:d[5]}}},
    {"name": "OUTOPTION$subexpression$1", "symbols": [/[oO]/, /[uU]/, /[tT]/, /[fF]/, /[iI]/, /[eE]/, /[lL]/, /[dD]/], "postprocess": function(e){return e.join("")}},
    {"name": "OUTOPTION", "symbols": ["OUTOPTION$subexpression$1", "_", {"literal":"=","pos":192}, "_", "FIELDNAME"], "postprocess": function(d) {return {outfield:d[4]}}},
    {"name": "OUTOPTION$subexpression$2", "symbols": [/[oO]/, /[uU]/, /[tT]/, /[fF]/, /[iI]/, /[eE]/, /[lL]/, /[dD]/], "postprocess": function(e){return e.join("")}},
    {"name": "OUTOPTION", "symbols": ["OUTOPTION$subexpression$2", "_", {"literal":"=","pos":207}, "_", {"literal":"'","pos":211}, "QUOTEDFIELDNAME", {"literal":"'","pos":215}], "postprocess": function(d) {return {outfield:d[5]}}},
    {"name": "OUTOPTION$subexpression$3", "symbols": [/[oO]/, /[uU]/, /[tT]/, /[fF]/, /[iI]/, /[eE]/, /[lL]/, /[dD]/], "postprocess": function(e){return e.join("")}},
    {"name": "OUTOPTION", "symbols": ["OUTOPTION$subexpression$3", "_", {"literal":"=","pos":226}, "_", {"literal":"\"","pos":230}, "QUOTEDFIELDNAME", {"literal":"\"","pos":234}], "postprocess": function(d) {return {outfield:d[5]}}},
    ...
    {"name": "OPPOPTION", "symbols": ["OPPOPTION$subexpression$1", "_", {"literal":"=","pos":329}, "_", "OPPOPTION$ebnf$1"], "postprocess": function(d) {return {operation:d[4].join('')}}},
    {"name": "OPPOPTION$subexpression$2", "symbols": [/[oO]/, /[pP]/, /[eE]/, /[rR]/, /[aA]/, /[tT]/, /[iI]/, /[oO]/, /[nN]/], "postprocess": function(e){return e.join("")}},
    {"name": "OPPOPTION", "symbols": ["OPPOPTION$subexpression$2", "_", {"literal":"=","pos":345}, "_", {"literal":"\"","pos":349}, "QUOTEDOPT", {"literal":"\"","pos":353}], "postprocess": function(d) {return {operation:d[5]}}},
    {"name": "OPPOPTION$subexpression$3", "symbols": [/[oO]/, /[pP]/, /[eE]/, /[rR]/, /[aA]/, /[tT]/, /[iI]/, /[oO]/, /[nN]/], "postprocess": function(e){return e.join("")}},
    {"name": "OPPOPTION", "symbols": ["OPPOPTION$subexpression$3", "_", {"literal":"=","pos":364}, "_", {"literal":"'","pos":368}, "QUOTEDOPT", {"literal":"'","pos":372}], "postprocess": function(d) {return {operation:d[5]}}},
    ...
    {"name": "JSONRECIPE", "symbols": ["JSONRECIPE$subexpression$1", "_", {"literal":"=","pos":443}, "_", {"literal":"\"","pos":447}, "JSONCHARS", {"literal":"\"","pos":451}], "postprocess": function(d) {return {jsonRecipe:d[5]}}},
