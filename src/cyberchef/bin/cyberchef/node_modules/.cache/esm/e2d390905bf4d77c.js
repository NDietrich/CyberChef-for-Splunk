let OperationConfig,Utils,isWorkerEnvironment,Recipe,Dish,detectFileType,isType,chiSquared;_5bf‍.x([["default",()=>_5bf‍.o]]);_5bf‍.w("../config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_5bf‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}],["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);_5bf‍.w("../Recipe.mjs",[["default",["Recipe"],function(v){Recipe=v}]]);_5bf‍.w("../Dish.mjs",[["default",["Dish"],function(v){Dish=v}]]);_5bf‍.w("./FileType.mjs",[["detectFileType",["detectFileType"],function(v){detectFileType=v}],["isType",["isType"],function(v){isType=v}]]);_5bf‍.w("chi-squared",[["default",["chiSquared"],function(v){chiSquared=v}]]);
