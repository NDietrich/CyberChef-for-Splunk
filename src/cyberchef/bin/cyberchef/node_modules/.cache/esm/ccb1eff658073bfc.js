let utf8,fromBase64,toBase64,fromHex,fromDecimal,fromBinary;_580‍.x([["isNodeEnvironment",()=>isNodeEnvironment],["isWebEnvironment",()=>isWebEnvironment],["isWorkerEnvironment",()=>isWorkerEnvironment],["default",()=>_580‍.o],["sendStatusMessage",()=>sendStatusMessage],["debounce",()=>debounce]]);_580‍.w("utf8",[["default",["utf8"],function(v){utf8=v}]]);_580‍.w("./lib/Base64.mjs",[["fromBase64",["fromBase64"],function(v){fromBase64=v}],["toBase64",["toBase64"],function(v){toBase64=v}]]);_580‍.w("./lib/Hex.mjs",[["fromHex",["fromHex"],function(v){fromHex=v}]]);_580‍.w("./lib/Decimal.mjs",[["fromDecimal",["fromDecimal"],function(v){fromDecimal=v}]]);_580‍.w("./lib/Binary.mjs",[["fromBinary",["fromBinary"],function(v){fromBinary=v}]]);/**
...
class Utils {
    ...
    static convertToByteArray(str, type) {
        switch (type.toLowerCase()) {
            case "binary":
                return _580‍.a("fromBinary",fromBinary)(str);
            case "hex":
                return _580‍.a("fromHex",fromHex)(str);
            case "decimal":
                return _580‍.a("fromDecimal",fromDecimal)(str);
            case "base64":
                return _580‍.a("fromBase64",fromBase64)(str, null, "byteArray");
            case "utf8":
    ...
    static convertToByteString(str, type) {
        switch (type.toLowerCase()) {
            case "binary":
                return Utils.byteArrayToChars(_580‍.a("fromBinary",fromBinary)(str));
            case "hex":
                return Utils.byteArrayToChars(_580‍.a("fromHex",fromHex)(str));
            case "decimal":
                return Utils.byteArrayToChars(_580‍.a("fromDecimal",fromDecimal)(str));
            case "base64":
                return Utils.byteArrayToChars(_580‍.a("fromBase64",fromBase64)(str, null, "byteArray"));
            case "utf8":
                return _580‍.a("utf8",utf8).encode(str);
            case "latin1":
            default:
                return str;
        }
    ...
    static strToUtf8ArrayBuffer(str) {
        const utf8Str = _580‍.a("utf8",utf8).encode(str);
    ...
    static byteArrayToUtf8(byteArray) {
        ...
        try {
            const utf8Str = _580‍.a("utf8",utf8).decode(str);
            if (str.length !== utf8Str.length) {
                if (isWorkerEnvironment()) {
                    self.setOption("attemptHighlight", false);
                } else if (isWebEnvironment()) {
    ...
    static async displayFilesAsHTML(files) {
        ...
        const formatContent = function (buff, type) {
            if (type.startsWith("image")) {
                let dataURI = "data:";
                dataURI += type + ";";
                dataURI += "base64," + _580‍.a("toBase64",toBase64)(buff);
