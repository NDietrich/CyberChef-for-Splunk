let OperationConfig,OperationError,Operation,DishError,log,isWorkerEnvironment;_580‍.x([["default",()=>_580‍.o]]);_580‍.w("./config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_580‍.w("./errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);_580‍.w("./Operation.mjs",[["default",["Operation"],function(v){Operation=v}]]);_580‍.w("./errors/DishError.mjs",[["default",["DishError"],function(v){DishError=v}]]);_580‍.w("loglevel",[["default",["log"],function(v){log=v}]]);_580‍.w("./Utils.mjs",[["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);/**
...
class Recipe  {
    ...
    async _hydrateOpList() {
        if (!modules) {
            ...
            modules = await _580‍.i(/* webpackMode: "eager" */ "./config/modules/OpModules.mjs");
