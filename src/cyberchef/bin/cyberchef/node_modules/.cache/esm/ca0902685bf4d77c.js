let OperationError,isWorkerEnvironment,kbpgp,es6promisify;_5bf‍.x([["ASP",()=>ASP],["getSubkeySize",()=>getSubkeySize],["importPrivateKey",()=>importPrivateKey],["importPublicKey",()=>importPublicKey]]);_5bf‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);_5bf‍.w("../Utils.mjs",[["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);_5bf‍.w("kbpgp",[["default",["kbpgp"],function(v){kbpgp=v}]]);_5bf‍.w("es6-promisify",[["*",null,function(v){es6promisify=v}]]);/**
 * PGP functions.
 *
