let Utils,OperationError;_fd7‍.x([["toHex",()=>toHex],["toHexFast",()=>toHexFast],["fromHex",()=>fromHex],["TO_HEX_DELIM_OPTIONS",()=>TO_HEX_DELIM_OPTIONS],["FROM_HEX_DELIM_OPTIONS",()=>FROM_HEX_DELIM_OPTIONS]]);_fd7‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);_fd7‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);/**
 ...
 */
    ...
    if (byteLen < 1 || Math.round(byteLen) !== byteLen)
        throw new (_fd7‍.a("OperationError",OperationError))("Byte length must be a positive integer");

    if (delim !== "None") {
        const delimRegex = delim === "Auto" ? /[^a-f\d]|(0x)/gi : _fd7‍.a("Utils",Utils).regexRep(delim);
 ...
 */
       const TO_HEX_DELIM_OPTIONS = ["Space", "Percent", "Comma", "Semi-colon", "Colon", "Line feed", "CRLF", "0x", "0x with comma", "\\x", "None"];;_fd7‍.j(["TO_HEX_DELIM_OPTIONS"]);


/**
 * From Hexadecimal delimiters.
 */
       const FROM_HEX_DELIM_OPTIONS = ["Auto"].concat(TO_HEX_DELIM_OPTIONS);;_fd7‍.j(["FROM_HEX_DELIM_OPTIONS"]);
