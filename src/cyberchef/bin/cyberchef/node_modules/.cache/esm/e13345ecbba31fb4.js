let operations,sanitise;_bba‍.x([["default",()=>_bba‍.o]]);_bba‍.w("./index.mjs",[["operations",["operations"],function(v){operations=v}]]);_bba‍.w("./apiUtils.mjs",[["sanitise",["sanitise"],function(v){sanitise=v}]]);/**
...
class NodeRecipe {
    ...
    _validateIngredient(ing) {
        ...
        if (typeof ing === "string") {
            const op = _bba‍.a("operations",operations).find((op) => {
                return _bba‍.a("sanitise",sanitise)(op.opName) === _bba‍.a("sanitise",sanitise)(ing);
            });
            if (op) {
        ...
        // CASE operation given. Check its a chef operation and check its not flowcontrol
            ...
            if (_bba‍.a("operations",operations).includes(ing)) {
                return ing;
            } else {
...
_bba‍.d(NodeRecipe);_bba‍.j(["default"]);
