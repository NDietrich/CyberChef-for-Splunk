let Utils,OperationError;_580‍.x([["toBase64",()=>toBase64],["fromBase64",()=>fromBase64],["ALPHABET_OPTIONS",()=>ALPHABET_OPTIONS]]);_580‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);_580‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);/**
 * Base64 functions.
 *
 ...
 */
    ...
    if (typeof data == "string") {
        data = _580‍.a("Utils",Utils).strToByteArray(data);
    }

    alphabet = _580‍.a("Utils",Utils).expandAlphRange(alphabet).join("");
    if (alphabet.length !== 64 && alphabet.length !== 65) { // Allow for padding
        throw new (_580‍.a("OperationError",OperationError))(`Invalid Base64 alphabet length (${alphabet.length}): ${alphabet}`);
    }
 ...
 */
    ...
    return returnType === "string" ? _580‍.a("Utils",Utils).byteArrayToUtf8(output) : output;
}
