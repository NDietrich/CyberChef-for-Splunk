let OperationConfig,OperationError,Operation,DishError,log,isWorkerEnvironment;_c7d‍.x([["default",()=>_c7d‍.o]]);_c7d‍.w("./config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_c7d‍.w("./errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);_c7d‍.w("./Operation.mjs",[["default",["Operation"],function(v){Operation=v}]]);_c7d‍.w("./errors/DishError.mjs",[["default",["DishError"],function(v){DishError=v}]]);_c7d‍.w("loglevel",[["default",["log"],function(v){log=v}]]);_c7d‍.w("./Utils.mjs",[["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);/**
...
class Recipe  {
    ...
    async _hydrateOpList() {
        if (!modules) {
            ...
            modules = await _c7d‍.i(/* webpackMode: "eager" */ "./config/modules/OpModules.mjs");
