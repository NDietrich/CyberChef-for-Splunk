let operations,sanitise;_c67‍.x([["default",()=>_c67‍.o]]);_c67‍.w("./index.mjs",[["operations",["operations"],function(v){operations=v}]]);_c67‍.w("./apiUtils.mjs",[["sanitise",["sanitise"],function(v){sanitise=v}]]);/**
...
class NodeRecipe {
    ...
    _validateIngredient(ing) {
        ...
        if (typeof ing === "string") {
            const op = _c67‍.a("operations",operations).find((op) => {
                return _c67‍.a("sanitise",sanitise)(op.opName) === _c67‍.a("sanitise",sanitise)(ing);
            });
            if (op) {
        ...
        // CASE operation given. Check its a chef operation and check its not flowcontrol
            ...
            if (_c67‍.a("operations",operations).includes(ing)) {
                return ing;
            } else {
...
_c67‍.d(NodeRecipe);_c67‍.j(["default"]);
