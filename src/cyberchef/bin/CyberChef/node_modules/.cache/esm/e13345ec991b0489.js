let operations,sanitise;_991‍.x([["default",()=>_991‍.o]]);_991‍.w("./index.mjs",[["operations",["operations"],function(v){operations=v}]]);_991‍.w("./apiUtils.mjs",[["sanitise",["sanitise"],function(v){sanitise=v}]]);/**
...
class NodeRecipe {
    ...
    _validateIngredient(ing) {
        ...
        if (typeof ing === "string") {
            const op = _991‍.a("operations",operations).find((op) => {
                return _991‍.a("sanitise",sanitise)(op.opName) === _991‍.a("sanitise",sanitise)(ing);
            });
            if (op) {
        ...
        // CASE operation given. Check its a chef operation and check its not flowcontrol
            ...
            if (_991‍.a("operations",operations).includes(ing)) {
                return ing;
            } else {
...
_991‍.d(NodeRecipe);_991‍.j(["default"]);
