let Utils,OperationError;_a63‍.x([["toBinary",()=>toBinary],["fromBinary",()=>fromBinary]]);_a63‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);_a63‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);/**
 * Binary functions.
 *
 ...
 */
    ...
    delim = _a63‍.a("Utils",Utils).charRep(delim);
    let output = "";
 ...
 */
    ...
    const delimRegex = _a63‍.a("Utils",Utils).regexRep(delim);
