let OperationConfig,OperationError,Operation,DishError,log,isWorkerEnvironment;_1cb‍.x([["default",()=>_1cb‍.o]]);_1cb‍.w("./config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_1cb‍.w("./errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);_1cb‍.w("./Operation.mjs",[["default",["Operation"],function(v){Operation=v}]]);_1cb‍.w("./errors/DishError.mjs",[["default",["DishError"],function(v){DishError=v}]]);_1cb‍.w("loglevel",[["default",["log"],function(v){log=v}]]);_1cb‍.w("./Utils.mjs",[["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);/**
...
class Recipe  {
    ...
    async _hydrateOpList() {
        if (!modules) {
            ...
            modules = await _1cb‍.i(/* webpackMode: "eager" */ "./config/modules/OpModules.mjs");
