let Operation,BACON_ALPHABETS,BACON_TRANSLATION_CASE,BACON_TRANSLATION_AMNZ,BACON_TRANSLATIONS,BACON_CLEARER_MAP,BACON_NORMALIZE_MAP,swapZeroAndOne;_79d‍.x([["default",()=>_79d‍.o]]);_79d‍.w("../Operation.mjs",[["default",["Operation"],function(v){Operation=v}]]);_79d‍.w("../lib/Bacon.mjs",[["BACON_ALPHABETS",["BACON_ALPHABETS"],function(v){BACON_ALPHABETS=v}],["BACON_TRANSLATION_CASE",["BACON_TRANSLATION_CASE"],function(v){BACON_TRANSLATION_CASE=v}],["BACON_TRANSLATION_AMNZ",["BACON_TRANSLATION_AMNZ"],function(v){BACON_TRANSLATION_AMNZ=v}],["BACON_TRANSLATIONS",["BACON_TRANSLATIONS"],function(v){BACON_TRANSLATIONS=v}],["BACON_CLEARER_MAP",["BACON_CLEARER_MAP"],function(v){BACON_CLEARER_MAP=v}],["BACON_NORMALIZE_MAP",["BACON_NORMALIZE_MAP"],function(v){BACON_NORMALIZE_MAP=v}],["swapZeroAndOne",["swapZeroAndOne"],function(v){swapZeroAndOne=v}]]);/**
