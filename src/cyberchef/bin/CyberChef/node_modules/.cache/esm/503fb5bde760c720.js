let Operation,OperationError,BombeMachine,ROTORS,ROTORS_FOURTH,REFLECTORS,Reflector,isWorkerEnvironment;_e76‍.x([["default",()=>_e76‍.o]]);_e76‍.w("../Operation.mjs",[["default",["Operation"],function(v){Operation=v}]]);_e76‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);_e76‍.w("../lib/Bombe.mjs",[["BombeMachine",["BombeMachine"],function(v){BombeMachine=v}]]);_e76‍.w("../lib/Enigma.mjs",[["ROTORS",["ROTORS"],function(v){ROTORS=v}],["ROTORS_FOURTH",["ROTORS_FOURTH"],function(v){ROTORS_FOURTH=v}],["REFLECTORS",["REFLECTORS"],function(v){REFLECTORS=v}],["Reflector",["Reflector"],function(v){Reflector=v}]]);_e76‍.w("../Utils.mjs",[["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);/**
