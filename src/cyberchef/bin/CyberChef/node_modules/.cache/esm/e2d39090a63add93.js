let OperationConfig,Utils,isWorkerEnvironment,Recipe,Dish,detectFileType,isType,chiSquared;_a63‍.x([["default",()=>_a63‍.o]]);_a63‍.w("../config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_a63‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}],["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);_a63‍.w("../Recipe.mjs",[["default",["Recipe"],function(v){Recipe=v}]]);_a63‍.w("../Dish.mjs",[["default",["Dish"],function(v){Dish=v}]]);_a63‍.w("./FileType.mjs",[["detectFileType",["detectFileType"],function(v){detectFileType=v}],["isType",["isType"],function(v){isType=v}]]);_a63‍.w("chi-squared",[["default",["chiSquared"],function(v){chiSquared=v}]]);
