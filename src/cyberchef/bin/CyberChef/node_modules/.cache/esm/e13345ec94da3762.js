let operations,sanitise;_94d‍.x([["default",()=>_94d‍.o]]);_94d‍.w("./index.mjs",[["operations",["operations"],function(v){operations=v}]]);_94d‍.w("./apiUtils.mjs",[["sanitise",["sanitise"],function(v){sanitise=v}]]);/**
...
class NodeRecipe {
    ...
    _validateIngredient(ing) {
        ...
        if (typeof ing === "string") {
            const op = _94d‍.a("operations",operations).find((op) => {
                return _94d‍.a("sanitise",sanitise)(op.opName) === _94d‍.a("sanitise",sanitise)(ing);
            });
            if (op) {
        ...
        // CASE operation given. Check its a chef operation and check its not flowcontrol
            ...
            if (_94d‍.a("operations",operations).includes(ing)) {
                return ing;
            } else {
...
_94d‍.d(NodeRecipe);_94d‍.j(["default"]);
