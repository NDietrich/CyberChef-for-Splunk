let Utils,OperationError;_dd3‍.x([["toBinary",()=>toBinary],["fromBinary",()=>fromBinary]]);_dd3‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);_dd3‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);/**
 * Binary functions.
 *
 ...
 */
    ...
    delim = _dd3‍.a("Utils",Utils).charRep(delim);
    let output = "";
 ...
 */
    ...
    const delimRegex = _dd3‍.a("Utils",Utils).regexRep(delim);
