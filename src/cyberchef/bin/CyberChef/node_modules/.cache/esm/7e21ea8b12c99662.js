let d3temp,nodomtemp,getScatterValues,getScatterValuesWithColour,RECORD_DELIMITER_OPTIONS,COLOURS,FIELD_DELIMITER_OPTIONS,Operation,Utils;_12c‍.x([["default",()=>_12c‍.o]]);_12c‍.w("d3",[["*",null,function(v){d3temp=v}]]);_12c‍.w("nodom",[["*",null,function(v){nodomtemp=v}]]);_12c‍.w("../lib/Charts.mjs",[["getScatterValues",["getScatterValues"],function(v){getScatterValues=v}],["getScatterValuesWithColour",["getScatterValuesWithColour"],function(v){getScatterValuesWithColour=v}],["RECORD_DELIMITER_OPTIONS",["RECORD_DELIMITER_OPTIONS"],function(v){RECORD_DELIMITER_OPTIONS=v}],["COLOURS",["COLOURS"],function(v){COLOURS=v}],["FIELD_DELIMITER_OPTIONS",["FIELD_DELIMITER_OPTIONS"],function(v){FIELD_DELIMITER_OPTIONS=v}]]);_12c‍.w("../Operation.mjs",[["default",["Operation"],function(v){Operation=v}]]);_12c‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);/**
