let OperationConfig,OperationError,Operation,DishError,log,isWorkerEnvironment;_12c‍.x([["default",()=>_12c‍.o]]);_12c‍.w("./config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_12c‍.w("./errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);_12c‍.w("./Operation.mjs",[["default",["Operation"],function(v){Operation=v}]]);_12c‍.w("./errors/DishError.mjs",[["default",["DishError"],function(v){DishError=v}]]);_12c‍.w("loglevel",[["default",["log"],function(v){log=v}]]);_12c‍.w("./Utils.mjs",[["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);/**
...
class Recipe  {
    ...
    async _hydrateOpList() {
        if (!modules) {
            ...
            modules = await _12c‍.i(/* webpackMode: "eager" */ "./config/modules/OpModules.mjs");
