let Utils,OperationError;_dd3‍.x([["toBase64",()=>toBase64],["fromBase64",()=>fromBase64],["ALPHABET_OPTIONS",()=>ALPHABET_OPTIONS]]);_dd3‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);_dd3‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);/**
 * Base64 functions.
 *
 ...
 */
    ...
    if (typeof data == "string") {
        data = _dd3‍.a("Utils",Utils).strToByteArray(data);
    }

    alphabet = _dd3‍.a("Utils",Utils).expandAlphRange(alphabet).join("");
    if (alphabet.length !== 64 && alphabet.length !== 65) { // Allow for padding
        throw new (_dd3‍.a("OperationError",OperationError))(`Invalid Base64 alphabet length (${alphabet.length}): ${alphabet}`);
    }
 ...
 */
    ...
    return returnType === "string" ? _dd3‍.a("Utils",Utils).byteArrayToUtf8(output) : output;
}
