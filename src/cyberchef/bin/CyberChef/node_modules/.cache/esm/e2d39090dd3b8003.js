let OperationConfig,Utils,isWorkerEnvironment,Recipe,Dish,detectFileType,isType,chiSquared;_dd3‍.x([["default",()=>_dd3‍.o]]);_dd3‍.w("../config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_dd3‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}],["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);_dd3‍.w("../Recipe.mjs",[["default",["Recipe"],function(v){Recipe=v}]]);_dd3‍.w("../Dish.mjs",[["default",["Dish"],function(v){Dish=v}]]);_dd3‍.w("./FileType.mjs",[["detectFileType",["detectFileType"],function(v){detectFileType=v}],["isType",["isType"],function(v){isType=v}]]);_dd3‍.w("chi-squared",[["default",["chiSquared"],function(v){chiSquared=v}]]);
