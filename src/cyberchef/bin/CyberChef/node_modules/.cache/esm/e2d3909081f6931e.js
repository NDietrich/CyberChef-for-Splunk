let OperationConfig,Utils,isWorkerEnvironment,Recipe,Dish,detectFileType,isType,chiSquared;_81f‍.x([["default",()=>_81f‍.o]]);_81f‍.w("../config/OperationConfig.json",[["default",["OperationConfig"],function(v){OperationConfig=v}]]);_81f‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}],["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);_81f‍.w("../Recipe.mjs",[["default",["Recipe"],function(v){Recipe=v}]]);_81f‍.w("../Dish.mjs",[["default",["Dish"],function(v){Dish=v}]]);_81f‍.w("./FileType.mjs",[["detectFileType",["detectFileType"],function(v){detectFileType=v}],["isType",["isType"],function(v){isType=v}]]);_81f‍.w("chi-squared",[["default",["chiSquared"],function(v){chiSquared=v}]]);
