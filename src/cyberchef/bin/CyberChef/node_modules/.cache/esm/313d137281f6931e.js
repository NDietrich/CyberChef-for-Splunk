let Utils,OperationError;_81f‍.x([["toBinary",()=>toBinary],["fromBinary",()=>fromBinary]]);_81f‍.w("../Utils.mjs",[["default",["Utils"],function(v){Utils=v}]]);_81f‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);/**
 * Binary functions.
 *
 ...
 */
    ...
    delim = _81f‍.a("Utils",Utils).charRep(delim);
    let output = "";
 ...
 */
    ...
    if (byteLen < 1 || Math.round(byteLen) !== byteLen)
        throw new (_81f‍.a("OperationError",OperationError))("Byte length must be a positive integer");

    const delimRegex = _81f‍.a("Utils",Utils).regexRep(delim);
