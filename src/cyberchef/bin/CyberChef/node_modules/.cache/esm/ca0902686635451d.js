let OperationError,isWorkerEnvironment,kbpgp,es6promisify;_663‍.x([["ASP",()=>ASP],["getSubkeySize",()=>getSubkeySize],["importPrivateKey",()=>importPrivateKey],["importPublicKey",()=>importPublicKey]]);_663‍.w("../errors/OperationError.mjs",[["default",["OperationError"],function(v){OperationError=v}]]);_663‍.w("../Utils.mjs",[["isWorkerEnvironment",["isWorkerEnvironment"],function(v){isWorkerEnvironment=v}]]);_663‍.w("kbpgp",[["default",["kbpgp"],function(v){kbpgp=v}]]);_663‍.w("es6-promisify",[["*",null,function(v){es6promisify=v}]]);/**
 * PGP functions.
 *
